		...
		<>
			<main>
				...
				<div className='mt-20 md:px-28'>
					...
					<div className='flex md:px-28 justify-center md:gap-48 mt-20'>
						<div className='flex flex-col md:max-w-[550px]'>
							<div className='mb-6'>
								<Image src={event1} alt='Palco com luzes' className='w-auto p-4 md:p-0 h-auto md:m-0 lg:m-0 md:h-[378px] lg:h-[378px]' />
							</div>
						...
						<div className='flex flex-col md:max-w-[550px]'>
							<div className='mb-6'>
								<Image src={event2} alt='Palco com luzes' className='w-auto p-4 md:p-0 h-auto md:m-0 lg:m-0 md:h-[378px] lg:h-[378px]' />
							</div>
			...
			<footer className='h-[250px] bg-[#001D32] mt-20 text-[#bdbfcb] mb-0'>
				<p>fasdfasd</p>
			</footer>
		</>
	);
